...
var init = function() {
	$.ajax({
		...
		reservoirData = resp;
		drawGraph("storageData", "Storage Data");
	});
...
var drawGraph = function(key, label) {
	var json_data = reservoirData[key];
	var result = [];
//	alert('json_dayta 0 '+json_data[i]);
			...
			.highcharts(
					{
						...
						title : {
							text : 'Water ' + label + ' from 2010 till date'
						},
						subtitle : {
